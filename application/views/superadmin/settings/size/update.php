 ...
 * Page Type             : View
 * Page Purpose         : update  Size
 * Controller Name     :  superadmin/Settings/size/
 * Alias                      : projectname_/superadmin/Settings/size/details/(sizeid)
 * Designed By           : 
 * Designed On           : --
 * Design Completed On  : --
 ...
 * Modified On          : 
 * Extra notes            :
 * Folder Path           : views/superadmin/Settings/size/update.php
 */
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="details col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="info col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="reg col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-push-2 col-md-push-2 col-sm-push-3 col-xs-push-0">
                            ...
                            <?php
                            $req=  json_decode($size_details);
                            if($req->code==SUCCESS_CODE)
                            {
                                $details=$req->size_details;
                            ?>
                            <form role="form" name="m_form" id="m_form" method="post">
                                <input type="hidden" name="size_id" id="size_id" value="<?php echo $details->id; ?>"/>
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label>Height<sup></sup><span id='height_error'></span></label>
                                            <input type="text" name="height" id="height" class="form-control input-md floatlabel" placeholder="Height" autocomplete="off"  maxlength="4" value="<?php echo $details->height; ?>"/>

                                        </div>
                                    </div>
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label>Width<sup></sup><span id='width_error'></span></label>
                                            <input type="text" name="width" id="width" class="form-control input-md floatlabel" placeholder="Width" autocomplete="off"  maxlength="4" value="<?php echo $details->width; ?>"/>
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label>Length<sup></sup><span id='length_error'></span></label>
                                            <input type="text" name="length" id="length" class="form-control input-md floatlabel" placeholder="Length" autocomplete="off" maxlength="4" value="<?php echo $details->length; ?>"/>
...
<script type="text/javascript">
    ...
    function add_feild()
    {
            ...
            dynamic+='<div class="col-xs-6 col-sm-6 col-md-6"><div class="form-group">    <label>Height<sup></sup></label><input type="text" name="height[]" id="height" class="form-control input-md floatlabel number_class" placeholder="Height" autocomplete="off"  maxlength="4"/></div></div>';
            dynamic+='<div class="col-xs-6 col-sm-6 col-md-6"><div class="form-group"><label>Width<sup></sup></label><input type="text" name="width[]" id="width" class="form-control input-md floatlabel number_class" placeholder="Width" autocomplete="off"  maxlength="4"/></div></div>';
            dynamic+='</div>';
            dynamic+='<div class="row">';
            dynamic+='<div class="col-xs-6 col-sm-6 col-md-6"><div class="form-group"><label>Length<sup></sup></label><input type="text" name="length[]" id="length" class="form-control input-md floatlabel number_class" placeholder="Length" autocomplete="off" maxlength="4"/></div></div>';
...
<script type="text/javascript">
    $('#m_form').on('submit', function (s) {
        s.preventDefault();
        str = true;
        $('#height_error,#width_error,#length_error').text('');
        $('#height,#width,#length').css('border','');
      ...
      $.ajax({
                   ...
                   url:"<?php echo SITE_ADMIN_LINK; ?>Settings/updateSize",
                   contentType: false,
                    cache: false,
                    processData: false,

                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" class="form-control input-md" placeholder="Enter Slider description" title="Enter Slider description"></textarea>
                                        </div>
                                    </div>
                                     <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label>URL Link<sup></sup><span id='url_error'></span></label>
                                            <textarea name="url" id="url" class="form-control input-md" placeholder="Enter URL Link" title="Enter URL details"></textarea>
...
$('#m_form').on('submit',function(s){
    ...
    if(str==true){
      $.ajax({
                   ...
                   url:"<?php echo SITE_ADMIN_LINK; ?>Settings/insertSlider",
                   contentType: false,
                    cache: false,
                    processData: false,

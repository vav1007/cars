            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-pad">
                    ...
                    <div class="bread col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right">
                        <button class="btn btn-success btn-md statusActivate" onclick="activateData(1,'slider');"><i class="fa fa-check" aria-hidden="true"></i>&nbsp;Active</button>
                        <button class="btn btn-warning btn-md statusDeActivate" onclick="deActivateData(0,'slider');"><i class="fa fa-ban" aria-hidden="true"></i>&nbsp;In Active</button>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo fetch_ucfirst($response->slidercontent); ?></td>
                                    <td><img src="<?php echo $response->sliderpath; ?>" style="height:150px;width:150px;"/></td>
                                    <td><?php echo $response->urllink; ?></td>
                                    ...
                                    <td><a href="<?php echo SITE_ADMIN_LINK; ?>Settings/slider/details/<?php echo urlencode($response->title); ?>/<?php echo $response->sliderid; ?>" class="btn btn-primary btn-md"><i class="fa fa-edit" aria-hidden="true"></i> Update</a></td>
                                </tr>
                                <?php } }  ?>
                                <tr>

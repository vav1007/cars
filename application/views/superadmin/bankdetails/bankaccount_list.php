...
/*
 * Page Name            : bankaccount_list.php
 * Page Type             : View
 * Page Purpose         :  Listing the bank accounts
 * Controller Name     :  superadmin/Welcome/bankaccouts
 * Alias                : projectname_/superadmin/Welcome/bankaccouts
 * Designed By           : 
 * Designed On           : --
 * Design Completed On  : --
 ...
 * Modified On          : 
 * Extra notes            :
 * Folder Path           : views/superadmin/bankdetails/bankaccount_list.php
 */
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-pad">
                    ...
                    <div class="bread col-lg-5 col-md-5 col-sm-5 col-xs-12 pull-right">
                        ...
                        <button class="btn btn-danger btn-md" onclick="deleteShow();" ><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;Delete</button>
                    </div>
                </div>
                <div class="clearfix"></div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 details-date">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-left search">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Account number, IFSC , City" aria-describedby="basic-addon2" name="search_name" id="search_name" autocomplete="off" maxlength="60"/>
                    ...
                    <div class="info col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <table class="table table-bordered">
                            <thead>
                                <?php 
                                //echo $faq_details;
                               $request=  json_decode($bank_details);
                                if($request->code==SUCCESS_CODE){
                                    $statisticks_result=$request->statistics;
                                ?>
                                <tr>
                                    <td>Statistics :</td>
                                    <td colspan="2">Total : <?php echo $statisticks_result->total; ?></td>
                                    <td>Active :  <?php echo $statisticks_result->active; ?></td>
                                    <td colspan="2">In-active : <?php echo $statisticks_result->inactive; ?></td>
                                    <td colspan="2">Current result count : <?php echo $statisticks_result->currentcount; ?></td>
                                </tr>
                                <?php } ?>
                                <tr>
                                    <th>Bank Name</th>
                            ...
                            <tbody>
                                ...
                                $colspan=9;
                                if($request->code==SUCCESS_CODE){
                                    foreach($request->bank_result as $response){
                                ?>
                                <tr>
                                    
                                    <td><?php echo fetch_ucfirst($response->bankname); ?></td>
                                    <td><?php echo fetch_ucfirst($response->accountnumber); ?></td>
                                    <td><?php echo fetch_ucfirst($response->ifsccode); ?></td>
                                    <td><?php echo fetch_ucfirst($response->accounttype); ?></td>
                                    <td><?php echo fetch_ucfirst($response->branch); ?></td>
                                    <td><?php echo fetch_ucfirst($response->address); ?></td>
                                    <td><?php echo fetch_ucfirst($response->city); ?></td>
                                    ...
                                    <td>
                                        <a href="<?php echo SITE_ADMIN_LINK; ?>Welcome/bankaccounts/details/<?php echo $response->id; ?>" class="btn btn-primary btn-md"><i class="fa fa-edit" aria-hidden="true"></i>  Update</a>
                                        <div class="clear">&nbsp;</div>
                                        <button class="btn btn-success btn-md statusActivate" onclick="activeBankAccount(<?php echo $response->id; ?>);"><i class="fa fa-check" aria-hidden="true"></i>&nbsp;Active</button>
                                    </td>
                                </tr>
                                <?php } }  ?>
                                <tr>
...
<script type="text/javascript">
    function activeBankAccount(id)
    {
            $.ajax({
                type:'JSON',
                method:'post',
                data:{'id':id},
                url:"<?php echo SITE_ADMIN_LINK; ?>Welcome/activeBankDetails",

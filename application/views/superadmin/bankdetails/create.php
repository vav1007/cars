 ...
 * Page Type             : View
 * Page Purpose         : Create bank   account details
 * Controller Name     :  superadmin/Welcome/bankaccount
 * Alias                      : projectname_/superadmin/Welcome/bankaccount
 * Designed By           : 
 * Designed On           : --
 * Design Completed On  : --
 ...
 * Modified On          : 
 * Extra notes            :
 * Folder Path           : views/superadmin/bankdetails/create.php
 */
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bankname" id="bankname" class="form-control input-md floatlabel" placeholder="Bank Name" autocomplete="off" maxlength="60"/>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="account_number" id="account_number" class="form-control input-md floatlabel" placeholder="Account Number" autocomplete="off" maxlength="30"/>
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="ifsccode" id="ifsccode" class="form-control input-md floatlabel" placeholder="IFSC Code" autocomplete="off" maxlength="30"/>
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="branch" id="branch" class="form-control input-md floatlabel" placeholder="Bank Branch" autocomplete="off" maxlength="30"/>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" id="address" placeholder="Enter Bank address ::" cols="45" rows="4"></textarea>
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="city" id="bank_city" class="form-control input-md floatlabel" placeholder="City" autocomplete="off" maxlength="30"/>
    ...
    if(city==''){$('#bank_city_error').html('Please enter city');$('#bank_city').css('border','1px solid red');str=false;}
     if(str==true){
      ...
      $.ajax({
                   ...
                   method:'POST',
                   data:formdetails,
                   url:"<?php echo SITE_ADMIN_LINK; ?>Welcome/insertBankDetails",

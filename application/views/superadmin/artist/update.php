...
$art_res=$artist_data->artist_result;
$updateid=$art_res->id;
$name=ucwords($art_res->name);
$email=$art_res->email;
$mobile=$art_res->mobile;
$city=ucwords($art_res->city);
$address=ucwords($art_res->address);
$profilepic=$art_res->profilepic;
$description=$art_res->description;
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <div class="details col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="info col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="reg col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-push-2 col-md-push-2 col-sm-push-3 col-xs-push-0">
                            <h4 class="text-left">Update Artist</h4>
                            <form role="form" name="update_artist_form" id="update_artist_form" method="post">
                                
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label>Name<sup>*</sup><span id="name_error"></span></label>
                                            <input type="text" name="name" id="name" class="form-control input-md floatlabel" placeholder="Name" title="Name" value="<?php echo $name;?>" maxlength="60" autocomplete="off"/>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label>Email<sup></sup><span id='email_error'></span></label>
                                            <input type="text" name="email" id="email" class="form-control input-md floatlabel" placeholder="Email" title="Email" maxlength="60" autocomplete="off" value="<?php echo $email;?>"/>
                                        </div>
                                    </div>
                                </div>
                                 <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mobile" id="mobile" class="form-control input-md floatlabel mobile_class" placeholder="Mobile" title="Mobile" maxlength="10" autocomplete="off" value="<?php echo $mobile;?>"/>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label>City<sup></sup><span id="artist_city_errror"></span></label>
                                            <input type="text" name="artist_city" id="artist_city" class="form-control input-md floatlabel" placeholder="City" title="City" maxlength="60" autocomplete="off" value="<?php echo $city;?>"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" id="address" class="form-control input-md floatlabel" placeholder="Address :: " title="Enter Address" ><?php echo $address;?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <label>About Artist<sup></sup><span id="about_artist_error"></span></label>
                                            <textarea name="about_artist" id="about_artist" class="form-control input-md floatlabel" placeholder="Describe about artist " title="Describe about artist" ><?php echo $description;?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                           <span><img style="height: 100px;width:100px;" src="<?php echo $profilepic;?>" /></span>
                                        </div>
                                    </div>
                                    <input type="hidden" id="updateid" name="updateid" value="<?php echo $updateid;?>"/>
                                    <input type="hidden" id="oldprofilepic" name="oldprofilepic" value="<?php echo $profilepic;?>"/>
                                    <!-- <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                              ...
                              <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6" id="btn_update_artist">
                                        <div class="form-group">
...
<script type="text/javascript">
    $('#update_artist_form').on('submit', function (p) {
        p.preventDefault();
...
//        if(about_artist==''){$('#about_artist').css('border','1px solid red').focus();$('#about_artist_error').html('Enter about artist');str=false;}
      ...
      $.ajax({
                   ...
                   url:"<?php echo SITE_ADMIN_LINK; ?>Other/updateArtist",
                   contentType: false,
                    cache: false,
                    processData: false,
                   success:function(data){
                        ...
                        switch(data.code)
                    {
                        ...
                        case 422:
                        case 575:
                            $('.display_message_class').html(data.description).addClass('alert alert-danger fade in'); $('#btn_update_artist').show();
                       break;
                    }
                    },

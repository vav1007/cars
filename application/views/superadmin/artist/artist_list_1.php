            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-pad">
                    ...
                    <div class="bread col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right">
                        <button class="btn btn-success btn-md statusActivate" onclick="activateData(1,'product');"><i class="fa fa-check" aria-hidden="true"></i>&nbsp;Active</button>
                        <button class="btn btn-warning btn-md statusDeActivate" onclick="deActivateData(0,'product');"><i class="fa fa-ban" aria-hidden="true"></i>&nbsp;In Active</button>
                        ...
                        <table class="table table-bordered">
                            <thead>
                               ...
                               $request=  json_decode($result_details);
                                ...
                                <tr>
                                    ...
                                    <td>Current result count : <?php echo $statisticks_result->inactive; ?></td>
                                </tr>
                                <?php } ?>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php echo base_url().UPLOADS.'artist/profilepic/'.$response->profilepic; ?>" style="height:50px;width:50px;"/></td>
                                    ...
                                    <td><a href="javascript:void(0)" onclick="alert('Coming Soon')" class="btn btn-primary btn-md"><i class="fa fa-search" aria-hidden="true"></i> View Details</a></td>
                                </tr>
                                <?php } }  ?>
                                <tr>

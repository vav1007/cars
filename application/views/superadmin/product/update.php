                            ...
                            ?>
                                ...
                                <div class="row">
                                                    ...
                                                    foreach ($submenu_req->menu_result as $submenu_response) {
                                                        ...
                                                        <optgroup label="<?php echo $submenu_response->menu; ?>">
                                                            <?php foreach ($submenu_response->submenu_result as $sm_response) { ?>
                                                                <option value="<?php echo $sm_response->id; ?>" <?php if($pro_res->submenuid==$sm_response->id){echo "selected";}?>><?php echo fetch_ucwords($sm_response->title); ?></option>
                                                            <?php } ?>
                                                        </optgroup>
                                                        <?php
                                                    }
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker form-control input-md" name="listsubmenu" id="listsubmenu">
                                                <?php if($pro_res->lsmid==0){?>
                                                <option value="">--Choose List Sub Menu--</option>
                                                <?php } else {?>
                                                <?php } ?>
                                                <option value="<?php echo "$pro_res->lsmid";?>"><?php echo "$pro_res->listsubmenu";?></option>
                                                <?php /*
                                  ...
                                  <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label>Show Art Price<sup></sup></label></br>
                                            <input type="checkbox" name="showprice" id="showprice" <?php if($pro_res->showprice==1){echo "checked "; echo 'value="1"';}?>/> Yes
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
...
<!--                                            <select class="selectpicker form-control input-md" name="size" id="size">
                                             ...
                                             */   ?>
                                             ...
                                             <input type="text" name="size" id="size" class="form-control input-md floatlabel number_class" placeholder="size" title="size" maxlength="20" autocomplete="off" value="<?php echo fetch_ucwords($pro_res->size); ?>"/>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <span class="form_loading_hide">
                                                <a href="<?php echo SITE_ADMIN_LINK; ?>Product"><button type="button" class="btn btn-default  btn-md pull-right">Cancel</button></a>
...
<script type="text/javascript">
    $('#product_form').on('submit', function (p) {
        p.preventDefault();
        str=true;
        $('#artist,#product_code,#submenu,#product_name,#medium,#year,#size,#quantity,#mrp,#sellingprice,#frameprice,#description,#productimage,#productimage_multiple').css('border','');
        $('#artist_error,#product_code_error,#submenu_error,#product_name_error,#medium_error,#year_error,#size_error,#quantity_error,#mrp_error,#sellingprice_error,#frameprice_error,#description_error,#productimage_error').text('');
...
//        var description=$('#description').val().trim();
        ...
        //if(medium=='' || medium=='0'){$('#medium').css('border','1px solid red').focus();$('#medium_error').html('Please fill medium details');str=false;}

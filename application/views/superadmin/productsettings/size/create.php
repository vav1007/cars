 ...
 * Page Type             : View
 * Page Purpose         :  Create  Size
 * Controller Name     :  superadmin/Settings/size/
 * Alias                      : projectname_/superadmin/Settings/size/Create
 * Designed By           : 
 * Designed On           : --
 * Design Completed On  : --
 ...
 * Modified On          : 
 * Extra notes            :
 * Folder Path           : views/superadmin/Settings/size/create.php
 */
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="details col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="info col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="reg col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-push-2 col-md-push-2 col-sm-push-3 col-xs-push-0">
                            <h4 class="text-center">Create  Size</h4>
                            <form role="form" name="m_form" id="m_form" method="post">
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label>Height<sup></sup><span id='height_error'></span></label>
                                            <input type="text" name="height" id="height" class="form-control input-md floatlabel" placeholder="Height" autocomplete="off"  maxlength="4"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="width" id="width" class="form-control input-md floatlabel" placeholder="Width" autocomplete="off"  maxlength="4"/>
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="length" id="length" class="form-control input-md floatlabel" placeholder="Length" autocomplete="off" maxlength="4"/>
...
<script type="text/javascript">
    $('#m_form').on('submit', function (s) {
      ...
      $.ajax({
                   ...
                   url:"<?php echo SITE_ADMIN_LINK; ?>Settings/insertSize",
                   contentType: false,
                    cache: false,
                    processData: false,

 ...
 * Page Name            : view.php
 * Page Type             : View
 * Page Purpose         :  Listing the Size
 * Controller Name     :  superadmin/Settings/size
 * Alias                      : projectname_/superadmin/Settings/size
 * Designed By           : 
 * Designed On           : --
 * Design Completed On  : --
 ...
 * Modified On          : 
 * Extra notes            :
 * Folder Path           : views/superadmin/settings/size/view.php
 */
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-pad">
                    ...
                    <div class="bread col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right">
                        <button class="btn btn-success btn-md statusActivate" onclick="activateData(1,'size');"><i class="fa fa-check" aria-hidden="true"></i>&nbsp;Active</button>
                        <button class="btn btn-warning btn-md statusDeActivate" onclick="deActivateData(0,'size');"><i class="fa fa-ban" aria-hidden="true"></i>&nbsp;In Active</button>
                    ...
                    <div class="info col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                $colspan=6;
                                if($request->code==SUCCESS_CODE){
                                    foreach($request->size_result as $response){
                                ?>
                                <tr>
                                    <td><input type="checkbox" name="multiple[]" value="<?php echo $response->id;  ?>"/></td>
                                    <td><?php echo fetch_ucfirst($response->height); ?></td>
                                    <td><?php echo fetch_ucfirst($response->width); ?></td>
                                    <td><?php echo fetch_ucfirst($response->length); ?></td>
                                    ...
                                    <td><a href="<?php echo SITE_ADMIN_LINK; ?>Settings/size/details/<?php echo $response->id; ?>"  class="btn btn-primary btn-md"><i class="fa fa-edit" aria-hidden="true"></i> Update</a></td>
                                </tr>
                                <?php } }  ?>
                                <tr>

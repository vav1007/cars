            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-pad">
                    ...
                    <div class="bread col-lg-4 col-md-4 col-sm-4 col-xs-12 pull-right">
                        <button class="btn btn-success btn-md statusActivate" onclick="activateData(1,'producttype');"><i class="fa fa-check" aria-hidden="true"></i>&nbsp;Active</button>
                        <button class="btn btn-warning btn-md statusDeActivate" onclick="deActivateData(0,'producttype');"><i class="fa fa-ban" aria-hidden="true"></i>&nbsp;In Active</button>
                    ...
                    <div class="info col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                $colspan=6;
                                if($request->code==SUCCESS_CODE){
                                    foreach($request->producttype_result as $response){
                                ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo SITE_ADMIN_LINK; ?>Productsettings/producttype/details/<?php echo $response->id; ?>"  class="btn btn-primary btn-md"><i class="fa fa-edit" aria-hidden="true"></i> Update</a></td>
                                </tr>
                                <?php } }  ?>
                                <tr>

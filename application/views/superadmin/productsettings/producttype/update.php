                ...
                <div class="details col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="info col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="reg col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-push-2 col-md-push-2 col-sm-push-3 col-xs-push-0">
                            <h4 class="text-center">Update  product Type</h4>
                            <?php
                            $req=  json_decode($producttype_details);
                            if($req->code==SUCCESS_CODE)
                            {
                                $details=$req->producttype_result;
                            ?>
                            <form role="form" name="m_form" id="m_form" method="post">
                                <input type="hidden" name="title_id" id="title_id" value="<?php echo $details->id; ?>"/>
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label>Title<sup></sup><span id='title_error'></span></label>
                                            <input type="text" name="title" id="title" class="form-control input-md floatlabel" placeholder="Title" autocomplete="off"  maxlength="50" value="<?php echo $details->title; ?>"/>
...
<script type="text/javascript">
    $('#m_form').on('submit', function (s) {
       ...
       if(title==''){$('#title_error').text('Please enter title'); str=false;} 
         if(str==true){
      $.ajax({
                    dataType:'JSON',
                   method:'POST',
                   data:new FormData(this),
                   url:"<?php echo SITE_ADMIN_LINK; ?>Productsettings/updateProductType",
                   contentType: false,
                    cache: false,
                    processData: false,

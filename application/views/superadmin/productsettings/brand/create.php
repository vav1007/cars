                            ...
                            <form role="form" name="m_form" id="m_form" method="post">
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                     ...
                                     <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label>Brand Icon ( Size : _ _ * _ _)<sup>*</sup><span id='sliderimage_error'></span></label>
...
$('#m_form').on('submit',function(s){
    ...
    if(title=='' || title=='0'){$('#title').css('border','1px solid red').focus();$('#title_error').html('Please enter brand name');str=false;}
    ...
    if(str==true){
      $.ajax({
                   ...
                   url:"<?php echo SITE_ADMIN_LINK; ?>Productsettings/insertBrand",
                   contentType: false,
                    cache: false,
                    processData: false,

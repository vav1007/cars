            ...
            <div class="container-fluid">
                ...
                <div class="details col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="info col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <h4 class="text-center">Update  Shape</h4>
                            <?php
                            ...
                            <form role="form" name="m_form" id="m_form" method="post">
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                     ...
                                     <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label>Shape Image ( Size : _ _ * _ _)<sup>*</sup><span id='sliderimage_error'></span></label>
...
$('#m_form').on('submit',function(s){
    ...
    if(str==true){
      $.ajax({
                   ...
                   url:"<?php echo SITE_ADMIN_LINK; ?>Productsettings/updateShape",
                   contentType: false,
                    cache: false,
                    processData: false,

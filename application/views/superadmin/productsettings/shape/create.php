            ...
            <div class="container-fluid">
                ...
                <div class="details col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="info col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <h4 class="text-center">Create  Shape</h4>
                            <form role="form" name="m_form" id="m_form" method="post">
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                     ...
                                     <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label>Shape icon ( Size : _ _ * _ _)<sup></sup><span id='sliderimage_error'></span></label>
                                            <input type="file" name="sliderimage" id="sliderimage" class="form-control input-md floatlabel"  accept="image/*"  title="Upload icon"/>
                                        </div>
                                    </div>
                                </div>
...
$('#m_form').on('submit',function(s){
    ...
    if(title=='' || title=='0'){$('#title').css('border','1px solid red').focus();$('#title_error').html('Enter shape name');str=false;}
    //if(sliderimage==''){$('#sliderimage').css('border','1px solid red');$('#sliderimage_error').html('Please upload brand image');str=false;}
    ...
    if(str==true){
      $.ajax({
                   ...
                   url:"<?php echo SITE_ADMIN_LINK; ?>Productsettings/insertShape",
                   contentType: false,
                    cache: false,
                    processData: false,

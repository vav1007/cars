                           ...
                           if($req->code==SUCCESS_CODE){
                            ...
                            <form role="form" name="show_form" id="show_form" method="post">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div id="datepicker" class="input-group date" data-date-format="<?php echo date('d-m-Y',strtotime($details->showstartdate)); ?>">
                                                <input class="form-control date" type="text" name="startdate" id="startdate" placeholder="Start time" title="Start time" autocomplete="off" value="<?php echo date('d-m-Y',strtotime($details->showstartdate)); ?>"/>
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                            </div>
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div id="datepicker" class="input-group date" data-date-format="<?php echo date('d-m-Y',strtotime($details->showenddate)); ?>">
                                                <input class="form-control date" type="text" name="enddate" id="enddate" placeholder="End date" title="End date" autocomplete="off" value="<?php echo date('d-m-Y',strtotime($details->showenddate)); ?>"/>
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <a href="<?php echo SITE_ADMIN_LINK; ?>Other/shows"><button type="button" class="btn btn-default  btn-md pull-right">Reset</button></a>
...
<script type="text/javascript">
    $('#show_form').on('submit', function (p) {
        ...
        if(showtitle_err!='' || artist_err!='' || startdate_err!='' || enddate_err!=''){ str=false; }
       if(str==true)
       {
          $.ajax({
            type:"POST",

...
/*
 * Page Name            : submenulist.php
 * Page Type             : View
 * Page Purpose         :  Listing the Submenu
 * Controller Name     :  superadmin/Categories/subMenu
 * Alias                      : projectname_/superadmin/Categories/subMenu
 * Designed By           : 
 * Designed On           : --
 * Design Completed On  : --
 ...
 * Modified On          : 
 * Extra notes            :
 * Folder Path           : views/superadmin/categories/menu
 */
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-pad">
                    ...
                    <div class="bread col-lg-5 col-md-5 col-sm-5 col-xs-12 pull-right">
                        <button class="btn btn-success btn-md statusActivate" onclick="activateData(1,'submenu');"><i class="fa fa-check" aria-hidden="true"></i>&nbsp;Active</button>
                        <button class="btn btn-warning btn-md statusDeActivate" onclick="deActivateData(0,'submenu');"><i class="fa fa-ban" aria-hidden="true"></i>&nbsp;In Active</button>
                        ...
                        <button class="btn btn-danger btn-md  statusDisable" onclick="deleteData(5, 'submenu');"><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;Delete</button>
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="details col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 details-date">
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 pull-left">
                            <select name="search_menu" id="search_menu" class="minimal chanagecity col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12 pull-left search">
                            <button type="submit" id="sm_submit" class="btn btn-success btn-md">Search</button>
                        </div>
                    ...
                    <div class="info col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <table class="table table-bordered">
                            <thead>
                                <?php 
                               $request=  json_decode($submenu_details);
...
<!--                                    <th>Status</th>-->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img style="width:100px;height: 100px;" src="<?php echo $response->image;?>"/></td>
                                    <td><img style="width:100px;height: 100px;" src="<?php echo $response->icon;?>"/></td>
<!--                                     <td><?php echo $response->priority; ?></td>-->
                                    <td style="font-weight:bold;text-align:center;color:<?php echo ($response->status==1) ?'green':'red'; ?>"><?php echo fetch_ucfirst($response->submenustatus); ?></td>
                                    <td><a href="<?php echo $update_link; ?><?php echo urlencode($response->title); ?>/<?php echo base64_encode($response->id); ?>"  class="btn btn-primary btn-md"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Update</a></td>
                                </tr>
                                <?php } }  ?>
                                <tr>
...
$('#search_menu,#search_activation').on('change',function(){
    $('#sm_submit').click();
});
</script>

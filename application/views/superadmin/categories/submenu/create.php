            ...
            <div class="container-fluid">
                ...
                <div class="details col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="info col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <h4 class="text-center">Create Sub Menu</h4>
                            <form role="form" name="sm_form" id="sm_form" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title[]" autocomplete="off" id="title" class="form-control input-md floatlabel" placeholder="Title">
                                ...
                                <div class="row">
                                   <!--  <div class="col-xs-6 col-sm-6 col-md-6">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <a href="<?php echo SITE_ADMIN_LINK; ?>Categories/subMenu"><button type="button" class="btn btn-default  btn-md pull-right">Cancel</button></a>
                                            <button type="submit" id="btn_insert" class="btn btn-danger btn-md pull-right">Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<script type="text/javascript">
$('#sm_form').on('submit',function(smle){
    smle.preventDefault();
    str=true;
    $('.display_message_class').html('');
    $('#menu_error,#title_error').html('');
    $('#menu').css('border','');
    var menu=$('#menu').val().trim();
    var title=$('#title').val().trim();
    if(menu=='' || menu=='0'){$('#menu').css('border','1px solid red');$('#menu_error').html('Please choose menu');str=false;}
    if(title==''){$('#title').css('border','1px solid red');$('#title_error').html('Enter submenu title');str=false;}
   if(str==true){
    $('#btn_insert').hide();
    ...
    $.ajax({
                   ...
                   url:"<?php echo SITE_ADMIN_LINK; ?>Categories/insertSubMenu",
                   contentType: false,
                    cache: false,
                    processData: false,

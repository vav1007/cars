<?php
//echo $testimonials_details;
defined('BASEPATH') or die('Error occured while page loading');
/*
 * Page Name            : testimonials_list.php
 * Page Type             : View
 * Page Purpose         :  Listing the Testimonial's
 * Controller Name     :  superadmin/Cms/index
 * Alias                : projectname_/superadmin/Cms/
 * Designed By           : 
 * Designed On           : --
 * Design Completed On  : --
 * Created By            : kavitha
 ...
 * Modified On          : 
 * Extra notes            :
 * Folder Path           : views/superadmin/testimonials/testimonials_list
 */
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-pad">
                    ...
                    <div class="bread col-lg-5 col-md-5 col-sm-5 col-xs-12 pull-right">
                        <button class="btn btn-success btn-md statusActivate" onclick="activateData(1,'testimonials');"><i class="fa fa-check" aria-hidden="true"></i>&nbsp;Active</button>
                        <button class="btn btn-warning btn-md statusDeActivate" onclick="deActivateData(0,'testimonials');"><i class="fa fa-ban" aria-hidden="true"></i>&nbsp;In Active</button>
                    ...
                    <div class="info col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <table class="table table-bordered">
                            <thead>
                                <?php 
                                //echo $faq_details;
                               $request=  json_decode($testimonials_details);
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo SITE_ADMIN_LINK; ?>Cms/testimonials/details/<?php echo urlencode($response->title); ?>/<?php echo $response->id; ?>" class="btn btn-primary btn-md"><i class="fa fa-edit"></i> Update</a>
                                        <a class="btn btn-danger btn-md" onclick="confirm('confirm to delete ??')" href="<?php echo SITE_ADMIN_LINK; ?>Cms/deleteTestimonial/<?php echo $response->id; ?>"><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;Delete</a>
                                    </td> 
                                </tr>
                                <?php } }  ?>
                                <tr>

...
/*
 * Page Name            : faq_list.php
 * Page Type             : View
 * Page Purpose         :  Listing the FAQ's
 ...
 * Modified On          : 
 * Extra notes            :
 * Folder Path           : views/superadmin/faq/faq_list
 */
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-pad">
                    ...
                    <div class="bread col-lg-5 col-md-5 col-sm-5 col-xs-12 pull-right">
                        <button class="btn btn-success btn-md statusActivate" onclick="activateData(1,'faqs');"><i class="fa fa-check" aria-hidden="true"></i>&nbsp;Active</button>
                        <button class="btn btn-warning btn-md statusDeActivate" onclick="deActivateData(0,'faqs');"><i class="fa fa-ban" aria-hidden="true"></i>&nbsp;In Active</button>
                    ...
                    <div class="info col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <table class="table table-bordered">
                            <thead>
                                <?php 
                                //echo $faq_details;
                               $request=  json_decode($faq_details);
                            ...
                            <tbody>
                                ...
                                $colspan=9;
                                if($request->code==SUCCESS_CODE){
                                    foreach($request->faq_result as $response){
                                ?>
                                <tr>
                                    <td><input type="checkbox" name="multiple[]" value="<?php echo $response->id;  ?>"/></td>
                                    <td><?php echo fetch_ucfirst($response->question); ?></td>
                                    <td><?php echo fetch_ucfirst($response->answer); ?></td>
                                    ...
                                    <td><a href="<?php echo SITE_ADMIN_LINK; ?>Cms/faq/details/<?php echo $response->id; ?>" class="btn btn-primary btn-md"><i class="fa fa-edit" aria-hidden="true"></i>  Update</a></td>
                                </tr>
                                <?php } }  ?>
                                <tr>

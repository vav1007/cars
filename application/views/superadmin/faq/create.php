 ...
 * Page Type             : View
 * Page Purpose         :  Create Faq
 * Controller Name     :  superadmin/Cms/faq/Create
 * Alias                      : projectname_/superadmin/Cms/faq/Create
 * Designed By           : 
 * Designed On           : --
 * Design Completed On  : --
                               ...
                               <div class="row">
                                       <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="question" id="question" class="form-control input-md floatlabel" placeholder="Enter Question" title="Enter Question" rows="4" cols="10" autocomplete="off"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group">
                                            <label>Answer<sup>*</sup><span id="answer_error"></span></label>
                                            <textarea name="answer" id="answer" class="form-control input-md floatlabel" placeholder="Enter Answer" title="Enter Answer" rows="4" cols="10" ></textarea>
                                        </div>
                                        </div>
                                </div>
                                <div class="row">
    ...
    $('#faq_insert_form').on('submit', function (p) {
       ...
       if(str==true)
       {
          $.ajax({
            ...
            cache: false,
            processData: false,
            url:"<?php echo SITE_ADMIN_LINK; ?>Cms/insertfaq",
